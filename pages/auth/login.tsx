  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <img className="h-32 mx-auto" src="/assets/iconset/128@2x.png" alt="Hoopla Logo" />
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="mt-4 text-neutral-600 text-center items-center justify-center text-sm flex flex-col md:flex-row space-x-1">
          <span>Don&apos;t have an account?</span>
          <Link href="#">
            <a className="font-medium text-neutral-900">Create one.</a>
          </Link>
        </div>
      </div>
    </div>
