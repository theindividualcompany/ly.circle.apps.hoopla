...
export default function Page() {
    ...
    return (
      <section
        style={
          {
            // backgroundImage:
            //   "url(https://www.macobserver.com/wp-content/uploads/2019/03/workfeatured-do-not-disturb.png)",
            // backgroundPosition: "center center",
            // backgroundRepeat: "no-repeat",
            // backgroundSize: "cover",
          }
        }
        // className="h-4/12v relative w-full"
        ...
        <section className="space-y-6">
          ...
          <section className="mb-32">
            <blockquote className="letter mb-8">
              ...
              <Text className="mb-4">
                Yes, you'll get a notification. Your phone'll vibrate, play sound, whatever. Even
                if you're on DND.
              </Text>
              <Text className="mb-4">
  ...
  React.useEffect(() => {
    ...
    document.addEventListener("message", handleIt)
    return () => {
      document.removeEventListener("message", handleIt)
    }
  }, [])
